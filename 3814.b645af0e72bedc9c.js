...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.didLoad = false;
    this.setupGesture = /*#__PURE__*/(0,_Users_ntipl_Documents_ionic_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
